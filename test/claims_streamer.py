...
for i in range(num_of_trials):
    payload["id"]= i
    payload["object"]['object']['object1']= i
    payload["object"]['object']['object']= f"objectoos{i}"
...
channel.basic_publish(
    'amq.topic', 'group_key', 'Message to group_key',
...
channel.basic_publish(
    'amq.topic', 'standard_key', 'Message to standard_key',
    pika.BasicProperties(content_type='text/plain', delivery_mode=1))
